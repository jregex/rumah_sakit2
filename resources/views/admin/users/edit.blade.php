            ...
            <div class="card-body">
                <form action="{{ route('users.update', ['user'=>$users->id]) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" class="form-control form-control-alternative" id="username"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-8">
                            <div class="custom-file mb-2">
                                <input type="file" class="form-control form-control-alternative" name="image" id="image"
