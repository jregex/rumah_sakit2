				...
				<div class="card mb-2">
					...
					<div class="card-body px-2 pt-0 pb-2">
						<div class="table-responsive p-0">
							<table class="table align-items-center justify-content-center mb-0" id="tb-dokter">
									...
									<tr>
										...
										<td class="align-middle">
											...
											<ul class="dropdown-menu bg-dark" aria-labelledby="dropdownMenuButton1">
												<li>
													<form
														action="{{ route('dokter.destroy', ['dokter' => $item->id]) }}"
														method="post">
														@method('delete')
														@csrf
												...
												<li><a class="dropdown-item text-white"
														href="{{ route('dokter.edit', ['dokter' => $item->id]) }}"><i
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control form-control-alternative" name="nama_dokter"
							id="nama_dokter" placeholder="Input nama dokter">
					</div>
					<div class="form-group">
...
<script src="{{ asset('assets/admin/assets/js/custom-js/dokter-set.js') }}"></script>
@endsection
